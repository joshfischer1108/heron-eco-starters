...
public class PublicFieldFibonacciSpout extends BaseRichSpout {

    private static final Logger LOG = Logger.getLogger(PublicFieldFibonacciSpout.class.getName());
    private SpoutOutputCollector collector;
    public String fieldName;

    public PublicFieldFibonacciSpout() {
    }


    public PublicFieldFibonacciSpout(String fieldName) {
